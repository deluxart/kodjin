...
?>
	<main id="home" class="onc_solution">
                ...
                <div class="case_study" data-aos="fade-up"
                    ...
                    <?php while ( have_rows( 'details_case_study' ) ) : the_row(); ?>
                        <div class="details">
                            ...
                            <?php if ( $link ) : ?>
                                <a href="<?php echo esc_url( $link) ; ?>" target="_blank" class="read">
        ...
        <div id="contact_expert" data-aos="fade-up"
            ...
            <div class="container">
                    <div class="wrap_btn">
                        <button data-name="request_demo" class="btn dark da-modal">Contact Experts</button>
                    </div>
            </div>
        </div>
...
<!--                    03-->
                    <?php if ( have_rows( 'section_roadmap_03' ) ) : ?>
                        <div class="block_section">
                            ...
                            <?php while ( have_rows( 'section_roadmap_03' ) ) : the_row(); ?>
                                ...
                                <div class="second_list">
                                    ...
                                    $count = count($items);
                                    $half = ceil($count / 2); // Половина массива

                                    // Выводим элементы в правильном порядке, но с обновленной нумерацией
                                    for ($i = 0; $i < $count; $i++) :
                                        // Нумерация по строкам: 1, 2, 3... для первой колонки, 4, 5, 6... для второй
                                        $number = ($i % 2 === 0)
                                            ? floor($i / 2) + 1 // Первая колонка
                                            : floor($i / 2) + 1 + $half; // Вторая колонка
                                        ?>
                                        <div class="item">
                                            <div class="num"><?php echo $number; ?></div> <!-- Правильная нумерация -->
                                            <div><?php echo $items[$i]; ?></div> <!-- Пункт остаётся на месте -->
                                        </div>
                                    <?php endfor; ?>
                                </div>
                            <?php endwhile; ?>

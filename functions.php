...
function kodjin_scripts() {
    ...
    wp_enqueue_style( 'kodjin-styles', get_template_directory_uri() . '/assets/styles/styles.css?241020230232222', array(), '241020230232222' );
...
//    wp_enqueue_script( 'kodjin-eocnewsticker', get_template_directory_uri() . '/assets/js/libs/eocnewsticker_upd.js', array(), _S_VERSION, true ); // animate text plugin
    ...
    wp_enqueue_script( 'kodjin-main', get_template_directory_uri() . '/assets/js/main.js?24010802222', array(), '241020230232222', true );
    wp_enqueue_script('custom-script', get_template_directory_uri() . '/assets/js/custom-script.js', array(), '09010802', true );

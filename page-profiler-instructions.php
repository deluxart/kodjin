...
/*
* Template Name: FHIR Profiler instructions
*/
                            ...
                            <div class="buttons">
                                ...
                                <?php if ( have_rows( 'button_start' ) ) : ?>
                                    <?php while ( have_rows( 'button_start' ) ) : the_row(); ?>
                                        <?php if ( get_sub_field( 'enable_button' ) == 1 ) : ?>
                                            <a href="<?php the_sub_field( 'link' ); ?>" target="_blank" class="btn dark"><?php the_sub_field( 'title' ); ?></a>
                                        <?php endif; ?>
                                    <?php endwhile; ?>
                                <?php endif; ?>
                                <p style="font-size: 12px;margin: 0;">By clicking this button, you agree to our <a href="/terms-of-use" style="font-size: 12px;">Terms of Service</a></p>
                            </div>
                        <?php } ?>
                    </div>
                </div>

...
?>
    ...
    <main id="solution_page" class="about">
        ...
        <section id="head_slide" class="about" style="background-image: url('<?php echo esc_url( $section_bg_image['url'] ); ?>'); background-repeat: no-repeat; background-size: cover">
            <div class="container">
                <div class="row">
                    <div class="head_text">
                        <h1
                                ...
                                <?php while ( have_rows( 'actions_head' ) ) : the_row(); ?>
                                    <?php if ( have_rows( 'contact_us' ) ) : ?>
                                        <?php while ( have_rows( 'contact_us' ) ) : the_row(); ?>
                                            <a class="btn dark" href="<?php the_sub_field( 'link' ); ?>"><?php the_sub_field( 'title' ); ?></a>
                                        <?php endwhile; ?>
                                    <?php endif; ?>
                                <?php endwhile; ?>
                            <?php endif; ?>

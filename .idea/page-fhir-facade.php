<?php
/*
* Template Name: Page: FHIR Facade
*/
	...
	<main id="solution_page">
			...
			<div class="container">
				<div class="row">
					<div class="head_text">
						...
						<div class="description facade" data-aos="fade-up"
						   data-aos-easing="ease"
						   data-aos-duration="1000"
						   data-aos-delay="200">
						...
						<div class="actions" data-aos="fade-up"
							...
							<?php if ( have_rows( 'actions_head' ) ) : ?>
								<?php while ( have_rows( 'actions_head' ) ) : the_row(); ?>
									<?php if ( have_rows( 'schedule_a_demo' ) ) : ?>
										<?php while ( have_rows( 'schedule_a_demo' ) ) : the_row(); ?>
											<a data-name="<?php the_sub_field( 'link' ); ?>" class="da-modal btn white"><?php the_sub_field( 'title' ); ?></a>
										<?php endwhile; ?>
									<?php endif; ?>
								<?php endwhile; ?>
							<?php endif; ?>
		...
		<section class="fhir_server">
			<div class="container">
                ...
                <?php if ( have_rows( 'review_facade' ) ) : ?>
                    <div class="reviewBlock dark" data-aos="fade-up"
                         data-aos-easing="ease"
                         data-aos-duration="1000"
                         data-aos-delay="300">
                        <?php while ( have_rows( 'review_facade' ) ) : the_row(); ?>
                            <div class="quoteIcon">
                            ...
                            <div class="text">
                                <?php the_sub_field( 'review_text_facade' ); ?>
                            </div>
                            <?php if ( have_rows( 'author_review_facade' ) ) : ?>
                                <div class="author">
                                    <?php while ( have_rows( 'author_review_facade' ) ) : the_row(); ?>
                                        <?php
...
<!--									--><?php //if ( have_rows( 'try_for_free' ) ) : ?>
<!--										--><?php //while ( have_rows( 'try_for_free' ) ) : the_row(); ?>
<!--											<div>-->
<!--												<a href="--><?php //the_sub_field( 'link' ); ?><!--" class="btn dark">--><?php //the_sub_field( 'title' ); ?><!--</a>-->
<!--											</div>-->
<!--										--><?php //endwhile; ?>
<!--									--><?php //endif; ?>
<!--								--><?php //endwhile; ?>
...
<!--						</div>-->
                    ...
                    <div class="actions">
                        <?php if ( have_rows( 'actions_all_features' ) ) : ?>
                            <?php while ( have_rows( 'actions_all_features' ) ) : the_row(); ?>
                                <a data-name="<?php the_sub_field( 'button_link' ); ?>" class="da-modal btn white"><?php the_sub_field( 'button_title' ); ?></a>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
                </div>
		...
		<section id="explore_more">
			<div class="container">
                ...
                <?php if ( have_rows( 'explore_more_actions' ) ) : $a_is_card = 1; ?>
                    <div class="cards actions">
                        <?php while ( have_rows( 'explore_more_actions' ) ) : the_row(); $a_is_card++; ?>

...
function kodjin_scripts() {
    ...
    wp_enqueue_style( 'kodjin-styles', get_template_directory_uri() . '/assets/styles/styles.css?444321', array(), '4441' );
    ...
    wp_enqueue_script( 'kodjin-sourcebuster', get_template_directory_uri() . '/assets/js/libs/sourcebuster.min.js', array(), '00333998222877', true );
    ...
    wp_enqueue_script( 'kodjin-eocnewsticker', get_template_directory_uri() . '/assets/js/libs/eocnewsticker_upd.js', array(), _S_VERSION, true );
    ...
    wp_enqueue_script( 'kodjin-main', get_template_directory_uri() . '/assets/js/main.js?414214', array(), '1242', true );
    wp_enqueue_script('custom-script', get_template_directory_uri() . '/assets/js/custom-script.js', array(), '987654322221', true );
                        ...
                        if (inputField_countryVal) {
                            fetch('https://api.ipify.org?format=json')
                                ...
                                .then(data => {
                                    ...
                                    fetch(`https://api.bigdatacloud.net/data/ip-country?ip=${userIpAddress}`)
                                        .then(response => response.json())
                                        .then(data => {
                                            const country = data.countryName;

						...
						<li>
							...
							<div id="dropdown1" class="dropdown">
								<ul role="menu">
									...
									<li role="menuitem">
										<a class="dropdown-link" href="<?php echo get_home_url(); ?>/fhir-server">
											Kodjin FHIR Server
										</a>
                                        <ul class="submenu">
                                            <li><a href="https://demo.kodjin.com/kodjin-demo" target="_blank">Free Demo Server</a></li>
						...
						<li>
							...
							<div id="dropdown3" class="dropdown">
								<ul role="menu">
									...
									<li role="menuitem">
										<a class="dropdown-link" href="<?php echo get_home_url(); ?>/resources/cases">Case Studies</a>
									</li>
									<li role="menuitem">
										<a class="dropdown-link" href="<?php echo get_home_url(); ?>/blog/category/news-and-events/">News and Events</a>
									</li>
									<li role="menuitem">
										<a class="dropdown-link" href="<?php echo get_home_url(); ?>/resources/webinars">Webinars</a>
									</li>
									<li role="menuitem">
										<a class="dropdown-link" href="<?php echo get_home_url(); ?>/resources/white-papers">Whitepapers</a>
									</li>
								</ul>
                                <div class="side">

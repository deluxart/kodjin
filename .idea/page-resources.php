                ...
                if ($query->have_posts()) {
                    while ($query->have_posts()) {
                        ...
                        <div class="swiper-slide card">
                            ...
                            <a href="<?php the_sub_field( 'link' ); ?>"><h3><?php the_title(); ?></h3></a>
            ...
            <section class="updates_by_category">
                ...
                <ul>
                    ...
                    <li data-aos="fade-left"
                        data-aos-easing="ease"
                        data-aos-duration="1000"
                        data-aos-delay="200"><a href="<?php echo get_home_url(); ?>/resources/white-papers">White Papers</a></li>
                    <li data-aos="fade-left"
                        data-aos-easing="ease"
                        data-aos-duration="1000"
                        data-aos-delay="300"><a href="<?php echo get_home_url(); ?>/resources/cases">Case studies</a></li>
                    <li data-aos="fade-left"
                        data-aos-easing="ease"
                        data-aos-duration="1000"
                        data-aos-delay="400"><a href="<?php echo get_home_url(); ?>/resources/webinars">Webinars</a></li>
                    <li data-aos="fade-left"
                        data-aos-easing="ease"
                        data-aos-duration="1000"
                        data-aos-delay="500"><a href="<?php echo get_home_url(); ?>/blog/category/news-and-events">News and events</a></li>
                </ul>
            </section>

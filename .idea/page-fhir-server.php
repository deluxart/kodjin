<?php
/*
* Template Name: Page: FHIR Server
*/
...
?>
	<main id="solution_page">
		...
		<section id="server_architecture">
			<div class="container">
		...
		<section id="server_in_context">
			<div class="container">
				<div class="head tc mb-32">
					<h2 data-aos="fade-up"
						data-aos-easing="ease"
						data-aos-duration="1000"
						data-aos-delay="100"><?php the_field( 'section_title_server_in_context' ); ?></h2>
				</div>
				<div class="scheme" data-aos="fade-up"
					 data-aos-easing="ease"
					 data-aos-duration="1000"
					 data-aos-delay="200">
					<?php $scheme_image_server_in_context = get_field( 'scheme_image_server_in_context' ); ?>
					<?php if ( $scheme_image_server_in_context ) : ?>
						<img src="<?php echo esc_url( $scheme_image_server_in_context['url'] ); ?>" alt="<?php echo esc_attr( $scheme_image_server_in_context['alt'] ); ?>" />
					<?php endif; ?>
				</div>

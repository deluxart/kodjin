...
?>
    <main id="solution_page" class="service">
        <section id="head_slide" class="service" style="background-image: url('<?php echo esc_url( $section_bg_image['url'] ); ?>'); background-repeat: no-repeat; background-size: cover">
            <div class="container">
                <div class="row">
                    <div class="head_text">
                        ...
                        <div class="actions" data-aos="fade-up"
                            ...
                            <?php if ( have_rows( 'actions_head' ) ) : ?>
                                <?php while ( have_rows( 'actions_head' ) ) : the_row(); ?>
                                    <a class="btn dark da-modal" data-name="<?php the_sub_field( 'button_link_actions' ); ?>"><?php the_sub_field( 'button_title_actions' ); ?></a>
                                <?php endwhile; ?>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <section class="fhir_server our_services">
            <div class="container">
                <div class="head mb-32 tc">
                    <h2 data-aos="fade-up"
                        data-aos-easing="ease"
                        data-aos-duration="1000"
                        data-aos-delay="100"><?php the_field( 'section_title_our_services' ); ?></h2>
                    <p data-aos="fade-up"
                       data-aos-easing="ease"
                       data-aos-duration="1000"
                       data-aos-delay="200"><?php the_field( 'section_description_our_services' ); ?></p>
                </div>
                <div class="cards">
                    <?php if ( have_rows( 'cards_our_services' ) ) : $f_is_card = 1; ?>
                        <?php while ( have_rows( 'cards_our_services' ) ) : the_row(); $f_is_card++; ?>
                    ...
                    <?php endif; ?>
                    <div class="actions">
                        <?php if ( have_rows( 'actions_kodjin_fhir_server' ) ) : ?>
                            <?php while ( have_rows( 'actions_kodjin_fhir_server' ) ) : the_row(); ?>
                                <?php $card_title = get_sub_field( 'title' ); ?>
                                <div data-aos="fade-up"
                                     data-aos-easing="ease"
                                     data-aos-duration="1000"
                                     data-aos-delay="<?php echo $f_is_card; ?>00" class="card <?php the_sub_field( 'card_color' ); ?>">
                                    <div>
                ...
                <div class="row">
                    <div class="head">
                        ...
                        <p data-aos="fade-up"
                           data-aos-easing="ease"
                           data-aos-duration="1000"
                           data-aos-delay="200"><?php the_field( 'description_specific_services' ); ?></p>
                    </div>
                    <?php if ( have_rows( 'list_specific_services' ) ) : $uc_list = 3; ?>
                        <ul class="list">
                            <?php while ( have_rows( 'list_specific_services' ) ) : the_row(); $uc_list++; ?>
                                <li data-aos="fade-left"
                                    data-aos-easing="ease"
                                    data-aos-duration="1000"
                                    data-aos-delay="<?php echo $uc_list; ?>00">
                                    <?php the_sub_field( 'title' ); ?>
                                </li>
                            <?php endwhile; ?>
                        </ul>
            ...
            <div class="container">
                <div class="head mb-32">
                    ...
                    <div data-aos="fade-left"
                        ...
                        <a href="<?php echo get_home_url(); ?>/resources/cases" class="read_more">
                            <span>Read more</span>
        ...
        <section id="white_papers" class="blog_section">
            <div class="container">
                <div class="head mb-32">
                    <div>
                        <h2 data-aos="fade-up"
                            data-aos-easing="ease"
                            data-aos-duration="1000"
                            data-aos-delay="100"><?php the_field( 'section_title_white_papers' ); ?></h2>
                    </div>
                    <div data-aos="fade-left"
                         data-aos-easing="ease"
                         data-aos-duration="1000"
                         data-aos-delay="200" class="more">
                        <a href="<?php echo get_home_url(); ?>/resources/white-papers/" class="read_more">
                ...
                <?php echo do_shortcode('[whitepapers-list posts="6" hide_title="true" with_icon="true" order="date"]') ?>

        ...
        <div class="container">
            <div class="content_block<?php if ( $attach_whitepaper ) : ?> whitepaper<?php endif; ?>">
                <div class="sections">
                    ...
                    <?php if ( have_rows( 'case_layout' ) ): ?>
                        <?php while ( have_rows( 'case_layout' ) ) : the_row(); ?>
                            ...
                            <?php elseif ( get_row_layout() == 'about_the_project' ) : ?>
                                <section id="about" class="text_section">
                                    <?php if (get_sub_field( 'section_title_about' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_about' ); ?></h2>
                                    <?php } ?>
                                    <div class="text">
                                        <?php the_sub_field( 'section_description_about' ); ?>
                                    </div>
                                </section>
                            <?php elseif ( get_row_layout() == 'solution_highlights' ) : ?>
                                <section id="solution_highlights" class="text_section solution_highlights">
                                    <?php if (get_sub_field( 'section_title_solution_highlights' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_solution_highlights' ); ?></h2>
                                    <?php } ?>
                                    <div class="text">
                                        <?php the_sub_field( 'description_solution_highlights' ); ?>
                                    </div>
                                </section>
                            <?php elseif ( get_row_layout() == 'challenges' ) : ?>
                                <section id="challenges" class="text_section challenges">
                                    <?php if (get_sub_field( 'section_title_challenges' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_challenges' ); ?></h2>
                                    <?php } ?>
                                    <div class="blocks">
                            ...
                            <?php elseif ( get_row_layout() == 'our_solution' ) : ?>
                                <section id="our_solution" class="text_section our_solution">
                                    <?php if (get_sub_field( 'section_title_our_solution' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_our_solution' ); ?></h2>
                                    <?php } ?>
                                    <div class="blocks">
                            ...
                            <?php elseif ( get_row_layout() == 'calling_block' ) : ?>
                                <section class="check_all_features">
                                    <div class="block">
                                        <h2><?php the_sub_field( 'block_title_calling' ); ?></h2>
                                        <?php the_sub_field( 'description_calling' ); ?>
                            ...
                            <?php elseif ( get_row_layout() == 'results' ) : ?>
                                <section id="results" class="text_section results">
                                    <?php if (get_sub_field( 'section_title_results' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_results' ); ?></h2>
                                    <?php } ?>
                                    <div class="text">
                                        <?php the_sub_field( 'description_results' ); ?>
                                    </div>
                                </section>
                            <?php elseif ( get_row_layout() == 'future_development' ) : ?>
                                <section id="future_development" class="text_section future_development">
                                    <?php if (get_sub_field( 'section_title_future_development' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_future_development' ); ?></h2>
                                    <?php } ?>
                                    <div class="text">
                                        <?php the_sub_field( 'description_future_development' ); ?>
                                    </div>
                                </section>
                            <?php elseif ( get_row_layout() == 'technology_stack' ) : ?>
                                <section id="technology_stack" class="text_section technology_stack">
                                    <?php if (get_sub_field( 'section_title_technology_stack' )) { ?>
                                        <h2><?php the_sub_field( 'section_title_technology_stack' ); ?></h2>
                                    <?php } ?>
                                    <div class="list">
                            ...
                            <?php elseif ( get_row_layout() == 'testimonials' ) : ?>
                                <section id="testimonial" class="text_section testimonial">
                                    <h2 class="mb-32"><?php the_sub_field( 'section_title_testimonials' ); ?></h2>

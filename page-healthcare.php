...
?>
	<main id="solution_page" class="healthcare">
		<section id="head_slide" class="solution healthcare" style="background-image: url('<?php echo esc_url( $section_bg_image['url'] ); ?>'); background-repeat: no-repeat; background-size: cover">
			<div class="container">
				<div class="row">
					<div class="head_text">
									...
									<?php while ( have_rows( 'actions_head' ) ) : the_row(); ?>
										...
										<?php if ( have_rows( 'request_demo' ) ) : ?>
											<?php while ( have_rows( 'request_demo' ) ) : the_row(); ?>
												<button data-name="request_demo" class="btn white white da-modal"><?php the_sub_field( 'title' ); ?></button>
											<?php endwhile; ?>
										<?php endif; ?>
									<?php endwhile; ?>
								<?php endif; ?>
		...
		<section id="fhir_vendor">
			<div class="container">
				<div class="head" data-aos="fade-right"
					 ...
					 data-aos-delay="100">
					<div>
						<h2 class="mb-32"><?php the_field( 'section_title_the_history_behind' ); ?></h2>
                        <div>
                            <button data-name="request_demo" class="btn dark da-modal">Request Demo</button>
                        </div>
					</div>
...
<!--                                    </a>-->
		...
		<section id="server_architecture" class="healthcare">
			<div class="container">
				<div class="head tc mb-32">
					<h2 data-aos="fade-up"
						data-aos-easing="ease"
						data-aos-duration="1000"
						data-aos-delay="100"><?php the_field( 'section_title_fhir_server_architecture' ); ?></h2>
					<p data-aos="fade-up"
					   data-aos-easing="ease"
					   data-aos-duration="1000"
					   data-aos-delay="200"><?php the_field( 'section_description_fhir_server_architecture' ); ?></p>
				</div>
				<div class="content" data-aos="fade-up"
					 data-aos-easing="ease"
					 data-aos-duration="1000"
					 data-aos-delay="300">
					<?php $scheme_image_fhir_server_architecture = get_field( 'scheme_image_fhir_server_architecture' ); ?>
					<?php if ( $scheme_image_fhir_server_architecture ) : ?>
						<img src="<?php echo esc_url( $scheme_image_fhir_server_architecture['url'] ); ?>" alt="<?php echo esc_attr( $scheme_image_fhir_server_architecture['alt'] ); ?>" />
					<?php endif; ?>
				</div>
			</div>
		</section>

		<section id="server_in_context" class="healthcare">
			<div class="container">
				<div class="head mb-32">
					<h2 data-aos="fade-up"
						data-aos-easing="ease"
						data-aos-duration="1000"
						data-aos-delay="100" class="mb-24"><?php the_field( 'section_title_server_in_context' ); ?></h2>
                    <p data-aos="fade-up"
                       data-aos-easing="ease"
                       data-aos-duration="1000"
                ...
                <p class="descr" data-aos="fade-up"
                    data-aos-easing="ease"
                    data-aos-duration="1000" data-aos-delay="100"><?php the_field( 'second_description_server_in_context' ); ?></p>
				<?php if ( have_rows( 'actions_server_in_context' ) ) : $a_context_card = 1; ?>
					<div class="cards actions">
						<?php while ( have_rows( 'actions_server_in_context' ) ) : the_row(); $a_context_card++; ?>
							<?php $card_title = get_sub_field( 'title' ); ?>
							<div data-aos="fade-up"
								 data-aos-easing="ease"
								 data-aos-duration="1000"
								 data-aos-delay="<?php echo $a_context_card; ?>00" class="card <?php the_sub_field( 'card_color' ); ?>">
								<div>
									<div class="cont <?php if ( have_rows( 'list_content' ) ) : ?>list_content<?php endif; ?>">
										<?php if ( have_rows( 'list_content' ) ) : ?>
											<h5><?php echo $card_title ?></h5>
			...
			<div class="container">
				<div class="head">
					<h2 data-aos="fade-up"
						data-aos-easing="ease"
						data-aos-duration="1000"
						data-aos-delay="100"><?php the_field( 'section_title_rely_edenlab_team' ); ?></h2>
				</div>
				<?php if ( have_rows( 'cards_rely_edenlab_team' ) ) : $why_item = 1; ?>
					<div class="items">
						<?php while ( have_rows( 'cards_rely_edenlab_team' ) ) : the_row(); $why_item++; ?>
							<div data-aos="fade-up"
								 data-aos-easing="ease"
								 data-aos-duration="1000"

			...
			<div class="container">
				<div class="head tc mb-32">
                    <div  data-aos="fade-up"
                          ...
                          data-aos-duration="1000"
                          data-aos-delay="100">
					<h2><?php the_field( 'section_title_fhir_server_architecture' ); ?></h2></div>
					<p data-aos="fade-up"
					   data-aos-easing="ease"
					   data-aos-duration="1000"
		...
		<section id="server_in_context">
			<div class="container">
				<div class="head tc mb-32" data-aos="fade-up"
                     ...
                     data-aos-duration="1000"
                     data-aos-delay="100">
					<h2><?php the_field( 'section_title_server_in_context' ); ?></h2>
				</div>
			...
			<div class="container">
				<div class="head tc mb-32">
                    <div data-aos="fade-up"
                         ...
                         data-aos-duration="1000"
                         data-aos-delay="100">
					<h2><?php the_field( 'section_title_explore_more' ); ?></h2></div>
					<p data-aos="fade-up"
					   data-aos-easing="ease"
					   data-aos-duration="1000"
